...
#include "../Asteria/infra/calibrationworker.h"
...
QT_MOC_LITERAL(4, 40, 3), // "utc"
QT_MOC_LITERAL(5, 44, 7) // "process"

    },
    "CalibrationWorker\0finished\0\0std::string\0"
    "utc\0process"
};
...
void CalibrationWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CalibrationWorker *_t = static_cast<CalibrationWorker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CalibrationWorker::*_t)(std::string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CalibrationWorker::finished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CalibrationWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CalibrationWorker.data,
      qt_meta_data_CalibrationWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CalibrationWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CalibrationWorker.stringdata0))
        return static_cast<void*>(const_cast< CalibrationWorker*>(this));
...
// SIGNAL 0
void CalibrationWorker::finished(std::string _t1)
{
