...
BOOST_CLASS_EXPORT(PinholeCameraWithRadialAndTangentialDistortion)

PinholeCameraWithRadialAndTangentialDistortion::PinholeCameraWithRadialAndTangentialDistortion()  :
    PinholeCamera(), K2(0.0), p1(0.0), p2(0.0) {

}

PinholeCameraWithRadialAndTangentialDistortion::PinholeCameraWithRadialAndTangentialDistortion(const unsigned int &width, const unsigned int &height, const double &fi,
...
PinholeCamera * PinholeCameraWithRadialAndTangentialDistortion::convertToPinholeCamera() const {

    fprintf(stderr, "Converting a PinholeCameraWithRadialAndTangentialDistortion to a PinholeCamera\n");
...
PinholeCameraWithRadialDistortion * PinholeCameraWithRadialAndTangentialDistortion::convertToPinholeCameraWithRadialDistortion() const {

    fprintf(stderr, "Converting a PinholeCameraWithRadialAndTangentialDistortion to a PinholeCameraWithRadialDistortion\n");
...
PinholeCameraWithRadialAndTangentialDistortion * PinholeCameraWithRadialAndTangentialDistortion::convertToPinholeCameraWithRadialAndTangentialDistortion() const {

    fprintf(stderr, "Converting a PinholeCameraWithRadialAndTangentialDistortion to a PinholeCameraWithRadialAndTangentialDistortion\n");
...
void PinholeCameraWithRadialAndTangentialDistortion::init() {
...
unsigned int PinholeCameraWithRadialAndTangentialDistortion::getNumParameters() const {
    return 5;
}

void PinholeCameraWithRadialAndTangentialDistortion::getParameters(double * params) const {
    params[0] = fi;
    params[1] = fj;
    params[2] = pi;
    params[3] = pj;
...
void PinholeCameraWithRadialAndTangentialDistortion::getIntrinsicPartialDerivatives(double *derivs, const Eigen::Vector3d & r_cam) const {
...
void PinholeCameraWithRadialAndTangentialDistortion::getExtrinsicPartialDerivatives(double *derivs, const Eigen::Vector3d &r_sez, const Quaterniond &q_sez_cam) const {
...
void PinholeCameraWithRadialAndTangentialDistortion::setParameters(const double *params) {
    fi = params[0];
    fj = params[1];
    pi = params[2];
    pj = params[3];
...
Eigen::Vector3d PinholeCameraWithRadialAndTangentialDistortion::deprojectPixel(const double & i, const double & j) const {
...
bool PinholeCameraWithRadialAndTangentialDistortion::projectVector(const Eigen::Vector3d & r_cam, double & i, double & j) const {
...
std::string PinholeCameraWithRadialAndTangentialDistortion::getModelName() const {
    return "PinholeCameraWithRadialAndTangentialDistortion";
}
...
double PinholeCameraWithRadialAndTangentialDistortion::getForwardRadialDistortionFactor(const double &R) const {
    return 1 + K2*R*R;
}

double PinholeCameraWithRadialAndTangentialDistortion::getBackwardRadialDistortionFactor(const double &R_prime, const double &tol) const {
...
void PinholeCameraWithRadialAndTangentialDistortion::getDistortedPixel(const double &i, const double &j, double &ip, double &jp) const {
...
void PinholeCameraWithRadialAndTangentialDistortion::getUndistortedPixel(const double &ip, const double &jp, double &i, double &j) const {
